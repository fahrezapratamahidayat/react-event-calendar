...
const dummyEvents = [
  ...
  },
  {
    ...
    startDate: new Date('2025-02-30T15:00:00'),
    endDate: new Date('2025-02-30T17:00:00'),
    startTime: '15:00',
    endTime: '17:00',
  ...
  },
  {
    ...
    description: 'Festival teknologi terbesar di Indonesia',
    startDate: new Date('2025-04-22T09:00:00'),
    endDate: new Date('2025-04-24T17:00:00'),
    startTime: '09:00',
    endTime: '17:00',
    location: 'ICE BSD',
    category: 'conference',
  ...
  {
    id: '12',
    title: 'Hackathon Nasional 2025 - Kategori A',
    description: 'Coding marathon 48 jam non-stop',
    startDate: new Date('2025-04-25T08:00:00'),
    endDate: new Date('2025-04-27T08:00:00'),
    startTime: '08:00',
    endTime: '08:00',
  ...
  {
    id: '13',
    title: 'Hackathon Nasional 2025 - Kategori B',
    description: 'Coding marathon 48 jam non-stop',
    startDate: new Date('2025-04-25T08:00:00'),
    endDate: new Date('2025-04-28T08:00:00'),
    startTime: '08:00',
    endTime: '08:00',
    location: 'Digital Hub Jakarta',
    category: 'competition',
  ...
  {
    id: '14',
    title: 'Hackathon Nasional 2025 - Kategori C',
    description: 'Coding marathon 48 jam non-stop',
    startDate: new Date('2025-04-25T08:00:00'),
    endDate: new Date('2025-04-28T08:00:00'),
    startTime: '08:00',
  ...
  {
    id: '15',
    title: 'Hackathon Nasional 2025 - Kategori D',
    description: 'Coding marathon 48 jam non-stop',
    startDate: new Date('2025-04-25T08:00:00'),
    endDate: new Date('2025-04-28T08:00:00'),
    startTime: '08:00',
